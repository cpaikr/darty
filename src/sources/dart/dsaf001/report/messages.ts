export const dsaf001ReportMessages = {
  ...
  documentNotFound: (documentId: string) =>
    `Document ID "${documentId}" was not found for this receipt. Omit documentId and call view-report again with receipt, then use the returned documents[].id. Do not pass DART dcmNo as documentId.`,
