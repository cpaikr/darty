export const dsae001CompanyMessages = {
  ...
  invalidStockCode: "Stock code format in a DART 기업개황 company-search result row is invalid.",
  rowParseFailed: "Could not parse a DART 기업개황 company-search result row.",
  sourceSchemaMismatch: "DART 기업개황 company-search results did not match the expected schema.",
  internalProvider: "Unexpected internal error while processing DART 기업개황 company search.",
} as const;
