...
The superseded TypeScript DART implementation, source-local toolset, and npm
CLI launcher are removed. TypeScript remains only in the thin Node facade and
