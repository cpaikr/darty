# Darty Proprietary License Agreement

Copyright (c) 2026 Sejun Park. All rights reserved.

This Darty Proprietary License Agreement (the "Agreement") governs your access to and use of the Darty software, including the CLI, package APIs, bundled files, documentation, updates, and related materials (the "Software").
...
The Software may access public DART web pages and third-party services. You are responsible for complying with applicable laws, third-party terms, rate limits, and acceptable-use rules. This Agreement does not grant rights to third-party data, websites, APIs, or services.
