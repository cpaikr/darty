...
export interface DisclosureTypesInput {
    readonly category?: string;
    readonly query?: string;
}
export interface DisclosureTypesResponse {
    readonly result: {
        readonly request: DisclosureTypesInput;
        readonly totalCount: number;
    ...
    readonly metadata: {
        ...
        readonly categoryLabelSource: {
            readonly system: string;
            readonly url: string;
            readonly codeSet: string;
        };
        readonly categoryDescriptionProvenance: {
            readonly status: string;
            readonly basis: string;
        };
        readonly sourceBehavior: {
            readonly codeSet: string;
            readonly categoryCodeSet: string;
            readonly observationStatus: string;
        };
        readonly completeness: Completeness;
    };
...
export interface ReportGuideResponse {
    readonly result: {
        readonly request: ReportGuideInput;
        readonly title: string;
...
export interface CompanyDetailResponse {
    readonly result: {
        readonly request: CompanyDetailInput;
...
export interface CompanyRssInput {
    readonly companyCode: string;
    readonly detail?: ResponseDetail;
}
export interface CompanyRssRequest extends CompanyRssInput {
    readonly detail: ResponseDetail;
}
